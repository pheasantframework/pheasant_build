...
void _renderElement(PheasantTemplate app, {AppState? appState, String? selector}) {
...
void createApp(PheasantTemplate pheasantTemplate, {AppState? appState, String? selector}) {
